...
class Danfce extends CommonNFePHP implements DocumentoNFePHP
{
    ...
    protected $urlConsulta = array(
        ...
        '1'=> array(
            '11'=> array(
                    'chave'=>'http://www.nfce.sefin.ro.gov.br/consultaAmbHomologacao.jsp',
                    'QR'=>'http://www.nfce.sefin.ro.gov.br/consultanfce/consulta.jsp'),
            '12'=> array(
                    'chave'=>'http://www.hml.sefaznet.ac.gov.br/nfce/consulta',
                    'QR'=>'http://www.hml.sefaznet.ac.gov.br/nfce/qrcode'),
            '13'=> array(
                    'chave'=>'http://homnfce.sefaz.am.gov.br/nfce-services/services/NfeConsulta2',
                    'QR'=>'http://homnfce.sefaz.am.gov.br/nfceweb/consultarNFCe.jsp'),
            '14'=> array(
                    'chave'=>'http://200.174.88.103:8080/nfce/servlet/wp_consulta_nfce',
                    'QR'=>'http://200.174.88.103:8080/nfce/servlet/qrcod'),
            '15'=> array(
                    'chave'=>'https://appnfc.sefa.pa.gov.br/portal-homologacao/view/consultas/nfce/consultanfce.seam',
                    'QR'=>'https://appnfc.sefa.pa.gov.br/portal-homologacao/view/consultas/nfce/nfceForm.seam'),
            '16'=> array(
                    'chave'=>'https://www.sefaz.ap.gov.br/sate1/seg/SEGf_AcessarFuncao.jsp?cdFuncao=FIS_1261',
            ...
            '21'=> array(
                    ...
                    'QR'=>'	http://homnfce.sefaz.am.gov.br/nfceweb/consultarNFCe.jsp'),
            '22'=> array(
                    'chave'=>'http://webas.sefaz.pi.gov.br/nfceweb-homologacao/consultarNFCe.jsf',
                    'QR'=>'http://webas.sefaz.pi.gov.br/nfceweb-homologacao/consultarNFCe.jsf'),
            '23'=> array(
                    'chave'=>'http://nfceh.sefaz.ce.gov.br/pages/consultaChaveAcesso.jsf',
                    'QR'=>'http://nfceh.sefaz.ce.gov.br/pages/ShowNFCe.html'),
            '24'=> array(
                    'chave'=>'http://nfce.set.rn.gov.br/consultarNFCe.aspx',
                    'QR'=>'http://nfce.set.rn.gov.br/consultarNFCe.aspx'),
            '25'=> array(
                    'chave'=>'http://www.receita.pb.gov.br/nfcehom',
                    'QR'=>'http://www.receita.pb.gov.br/nfcehom'),
            '26'=> array(
                    'chave'=>'http://nfcehomolog.sefaz.pe.gov.br/nfce-web/consultarNFCe',
                    'QR'=>'http://nfcehomolog.sefaz.pe.gov.br/nfce-web/consultarNFCe'),
            '27'=> array(
                    'chave'=>'',//Alagoas
                    'QR'=>''),
            '28'=> array(
                    'chave'=>'http://www.hom.nfe.se.gov.br/portal/consultarNFCe.jsp',
                    'QR'=>'http://www.hom.nfe.se.gov.br/portal/consultarNFCe.jsp'),
            '29'=> array(
                    'chave'=>'http://hnfe.sefaz.ba.gov.br/servicos/nfce/modulos/geral/NFCEC_consulta_chave_acesso.aspx',
                    'QR'=>'http://hnfe.sefaz.ba.gov.br/servicos/nfce/modulos/geral/NFCEC_consulta_chave_acesso.aspx'),
            '31'=> array(
                    'chave'=>'',//Minas Gerais
                    'QR'=>''),
            '32'=> array(
                    'chave'=>'',//Espírito Santo
                    'QR'=>''),
            '33'=> array(
                    'chave'=>'',
            ...
            '52'=> array(
                    ...
                    'QR'=>''),
            '53'=> array(
                    'chave'=>'http://dec.fazenda.df.gov.br/nfce',
        ...
        '2' => array(
            '11'=> array(
                    'chave'=>'http://www.nfce.sefin.ro.gov.br',
                    'QR'=>'http://www.nfce.sefin.ro.gov.br/consultanfce/consulta.jsp'),
            '12'=> array(
                    'chave'=>'http://www.sefaznet.ac.gov.br/nfce/consulta',
                    'QR'=>'http://www.sefaznet.ac.gov.br/nfce/qrcode'),
            '13'=> array(
                    'chave'=>'http://nfce.sefaz.am.gov.br/nfce-services/services/NfeConsulta2',
                    'QR'=>'http://sistemas.sefaz.am.gov.br/nfceweb/consultarNFCe.jsp'),
            '14'=> array(
                    'chave'=>'https://www.sefaz.rr.gov.br/nfce/servlet/wp_consulta_nfce',
                    'QR'=>'https://www.sefaz.rr.gov.br/nfce/servlet/qrcode'),
            '15'=> array(
                    'chave'=>'https://appnfc.sefa.pa.gov.br/portal/view/consultas/nfce/consultanfce.seam',
                    'QR'=>'https://appnfc.sefa.pa.gov.br/portal/view/consultas/nfce/nfceForm.seam'),
            '16'=> array(
                    'chave'=>'https://www.sefaz.ap.gov.br/sate/seg/SEGf_AcessarFuncao.jsp?cdFuncao=FIS_1261',
            ...
            '21'=> array(
                    ...
                    'QR'=>'http://sistemas.sefaz.am.gov.br/nfceweb/consultarNFCe.jsp'),
            '22'=> array(
                    'chave'=>'http://webas.sefaz.pi.gov.br/nfceweb/consultarNFCe.jsf',
                    'QR'=>'http://webas.sefaz.pi.gov.br/nfceweb/consultarNFCe.jsf'),
            '23'=> array(
                    'chave'=>'',//Ceará
                    'QR'=>''),
            '24'=> array(
                    ...
                    'QR'=>'http://nfce.set.rn.gov.br/consultarNFCe.aspx'),
            '25'=> array(
                    'chave'=>'http://www.receita.pb.gov.br/nfce',
                    'QR'=>'http://www.receita.pb.gov.br/nfce'),
            '26'=> array(
                    'chave'=>'http://nfce.sefaz.pe.gov.br/nfce-web/consultarNFCe',
                    'QR'=>'http://nfce.sefaz.pe.gov.br/nfce-web/consultarNFCe'),
            '27'=> array(
                    'chave'=>'',//Alagoas
                    'QR'=>''),
            '28'=> array(
                    'chave'=>'http://www.nfce.se.gov.br/portal/consultarNFCe.jsp',
    ...
    public function montaDANFE($detalhes = false)
    {
        ...
        $vTotTrib = (float)$this->pSimpleGetValue($this->ICMSTot, "vTotTrib");
        ...
        $urlChave = $this->urlConsulta[$tpAmb][$cUF]['chave'];//chave -> id
        if ($this->urlQR == '') {
